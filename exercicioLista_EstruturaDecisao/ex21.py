...
print(f'Para sacar o valor de R$ {saque} serão fornecidas as seguintes notas:')
nota = (saque // 100)
saque = (saque - (nota * 100))
print(f'Notas de 100: {nota}')

nota = (saque // 50)
saque = (saque - (nota * 50))
print(f'Notas de 50: {nota}')

nota = (saque // 10)
saque = (saque - (nota * 10))
print(f'Notas de 10: {nota}')

nota = (saque // 5)
saque = (saque - (nota * 5))
print(f'Notas de 5: {nota}')

nota = (saque // 1)
saque = (saque - (nota * 1))
print(f'Notas de 1: {nota}')
