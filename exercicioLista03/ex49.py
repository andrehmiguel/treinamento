# 49. Em uma competição de ginástica, cada atleta recebe votos de sete jurados. A
...
# sua média, conforme a descrição acima informada (retirar o melhor e o pior salto e
# depois calcular a média com as notas restantes). As notas não são informados
# ordenadas. Um exemplo de saída do programa deve ser conforme o exemplo
# abaixo:
