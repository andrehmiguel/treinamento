# 42. Foi feita uma estatística em cinco cidades brasileiras para coletar dados sobre
# acidentes de trânsito. Foram obtidos os seguintes dados:
# Código da cidade;
# Número de veículos de passeio (em 1999);
# Número de acidentes de trânsito com vítimas (em 1999).
# Deseja-se saber:
# Qual o maior e menor índice de acidentes de trânsito e a que cidade
# pertence;
...
print("\nMenos acidentes\nQuantidade de acidentes: ", min(n_acidentes), "\nCódigo da cidade: ",
      cod_cidades[indice_acidentes_menor])
print("\nMais acidentes\nQuantidade de acidentes: ", max(n_acidentes), "\nCódigo da cidade: ",
      cod_cidades[indice_acidentes_maior])
