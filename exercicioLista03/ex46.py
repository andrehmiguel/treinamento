# 46. Em uma eleição presidencial existem quatro candidatos. Os votos são informados
...
candidatos = ['João do Caminhão', 'Alberto da Feira', 'Tião do Ovo', 'Creuza Raimunda', 'Nulo', 'Branco']
votos = []
