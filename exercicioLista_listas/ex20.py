...
# se deve ter nenhuma preocupação com colaboradores com tempo menor de
# casa, descontos, impostos ou outras particularidades. Seu programa deverá
# permitir a digitação do salário de um número indefinido (desconhecido) de
# salários. Um valor de salário igual a 0 (zero) encerra a digitação. Após a
# entrada de todos os dados o programa deverá calcular o valor do abono
# concedido a cada colaborador, de acordo com a regra definida acima. Ao
...
# do programa, apenas para fins ilustrativos. Os valores podem mudar a cada
