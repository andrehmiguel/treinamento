...
total = sum(problemas)
print(f'1 - Necessita de esfera                  {problemas[0]}                       {(100 * problemas[0]) / total}')
print(f'2 - Necessita de limpeza                 {problemas[0]}                       {(100 * problemas[0]) / total}')
print(f'3 - Necessita troca do cabo ou conector  {problemas[0]}                       {(100 * problemas[0]) / total}')
print(f'4 - Quebrado ou inutilizado              {problemas[0]}                       {(100 * problemas[0]) / total}')
